  ...
  <div class="jumbotron rezgo-booking">
    ...
    <div class="row rezgo-form-group rezgo-confirmation-additional-info">
      ...
      <div class="col-md-5 col-xs-12 rezgo-company-info">
        ...
        <? } ?>
        <? } ?>
        <a href="javascript:void(0);" onclick="javascript:window.open('<?=$site->base?>/terms',null,'width=800,height=600,status=no,toolbar=no,menubar=no,location=no,scrollbars=1');">Click here to view terms and conditions.</a>
        </p>
