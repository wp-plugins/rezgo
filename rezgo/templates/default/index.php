...
<script>
  ...
  $(document).ready(function() {
    ...
    $.ajax({
      url: '<?=$site->ajax_url?>/index_ajax.php?parent_url=<?=$site->base?>&pg=' + start + '&start_date=' + search_start_date + '&end_date=' + search_end_date + '&tags=' + search_tags + '&search_in=' + search_in + '&search_for=' + search_for + '&cid=' + cid,
